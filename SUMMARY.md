  ...
  * [Concepts: Set 2](spring/concepts-set-2/README.md)
    ...
    * [Text Encoding](spring/concepts-set-2/text-encoding/README.md)
      * [Base Encoding](spring/concepts-set-2/text-encoding/base-encoding/README.md)
        * [Base16](spring/concepts-set-2/text-encoding/base-encoding/base16.md)
        ...
        * [Base64](spring/concepts-set-2/text-encoding/base-encoding/base64.md)
      * [ASCII](spring/concepts-set-2/text-encoding/ascii.md)
      * [Extended ASCII](spring/concepts-set-2/text-encoding/extended-ascii.md)
